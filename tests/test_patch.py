...
#py -m pytest tests/test_patch.py -v para ejecutarlo como prueba
#py -m pytest tests/test_patch.py -v --html=report.html --self-contained-html para ejecutarlo y realizar el reporte html
#py -m pytest -m api -v para ejecutar todas las pruebas api
@pytest.mark.api
def test_patch_user(url_base,header_base):
    HEADER = header_base
